    ...
    >
      <div className="flex items-start gap-3 p-4">
        ...
        <Button
          ...
          className="shrink-0 w-12 h-12 rounded-full bg-transparent text-foreground hover:bg-accent/20 transition-all disabled:opacity-50 shadow-none border-none"
        >
